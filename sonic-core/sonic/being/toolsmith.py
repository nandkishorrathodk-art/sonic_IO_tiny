...
class ToolsmithLoop:
    ...
    async def _llm_propose_tool(
        ...
        system = (
            "You are the toolsmith of an autonomous offensive-security being. "
            "Given an observation and prior failed attempts, propose ONE small, "
            "self-contained Python 3 tool (a scanner / fuzzer / parser / probe) "
            "that fills a gap NO existing tool covers. "
            f"Existing tools (do NOT duplicate): {existing_str}. "
            "Do NOT propose nmap/nuclei/ffuf/http_client — those exist. "
            "Output EXACTLY:\n"

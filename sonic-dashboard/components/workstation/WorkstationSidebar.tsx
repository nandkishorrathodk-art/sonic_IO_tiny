...
const NAV = [
  ...
  { href: "/sandbox", label: "Sandbox", icon: <Box className="w-4 h-4 text-secondary-400" /> },
  { href: "/terminal", label: "Terminal", icon: <Terminal className="w-4 h-4 text-success" /> },
];
          ...
          <>
            <div className="px-3 pt-3 pb-1 flex items-center justify-between text-xs text-muted">
              ...
              <button
                ...
                title="Create New Workstation Session"
              >
